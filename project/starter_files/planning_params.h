...
// Planning Constants
#define P_NUM_PATHS 7                  // Num of paths (goals): Too many offset goals (>7) might be unnecessary and computationally intensive
...
#define P_NUM_POINTS_IN_SPIRAL 16       // Too few = missed collisions. Too many = high computational penalty
